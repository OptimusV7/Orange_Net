                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                                                                            ...
                                                                                                            <img
                                                                                                                ...
                                                                                                                src="http://cdn.mcauto-images-production.sendgrid.net/927d2324a4fb79c2/99ea82f8-40c0-46e3-9e0a-7e2090c71b68/200x200.png"
                                                                                                                height="200">
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    </tbody>
                                                                                                ...
                                                                                                <table class="module"
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="font-size: 43px">Thanks for signing up, Jane!</span>
                                                                                                                </div>
                                                                                                                <div></div>
                                                                                                            </div>
                                                                                                        </td>
                                                                                                        ...
                                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                                            ...
                                                                                                            <div>
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="font-size: 18px">Please verify your email address to</span><span
                                                                                                                        style="color: #000000; font-size: 18px; font-family: arial, helvetica, sans-serif"> get access to Fast Internet</span><span
                                                                                                                        style="font-size: 18px">.</span>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="font-size: 18px; color: #ed4337"><strong>Thank you!</strong></span>
                                                                                                                </div>
                                                                                                                <div></div>
                                                                                                            </div>
                                                                                                        </td>
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td align="center"
                                                                                                                        ...
                                                                                                                        <a href=""
                                                                                                                           style="background-color:#ED4337; border:1px solid #ED4337; border-color:#ED4337; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                                                                ...
                                                                                                <table class="module"
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                    <tr>
                                                                                                        <td style="padding:50px 30px 50px 30px; line-height:22px; text-align:inherit; background-color:#9d9b9b;"
                                                                                                            height="100%"
                                                                                                            valign="top"
                                                                                                            bgcolor="#9d9b9b"
                                                                                                            role="module-content">
                                                                                                            <div>
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #ffffff; font-size: 18px"><strong>Here’s what happens next:</strong></span>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                                    <br>
                                                                                                                ...
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #ffffff; font-size: 18px">1. Login to your customer portal and pick one internet package</span>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                                    <br>
                                                                                                                ...
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #ffffff; font-size: 18px">2. Pay for the package and start enjoying internet</span>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                                    <br>
                                                                                                                ...
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #ffffff; font-size: 18px">Need support? Our support team is always</span>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #ffffff; font-size: 18px">ready to help!</span>
                                                                                                                </div>
                                                                                                                <div></div>
                                                                                                            </div>
                                                                                                        </td>
                                                                                                ...
                                                                                                <table border="0"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="center"
                                                                                                            bgcolor="#6e6e6e"
                                                                                                            class="outer-td"
                                                                                                            style="padding:0px 0px 0px 0px; background-color:#6e6e6e;">
                                                                                                            <table
                                                                                                                border="0"
                                                                                                                cellpadding="0"
                                                                                                                cellspacing="0"
                                                                        ...
                                                                        <div data-role="module-unsubscribe"
                                                                            ...
                                                                            <p style="font-size:12px; line-height:20px;">
                                                                                <a
                                                                                    ...
                                                                                    href="{{{unsubscribe}}}" style="">Unsubscribe</a>
                                                                                -
                                                                                    ...
                                                                                    <table border="0" cellpadding="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                ...
                                                                                                class="inner-td"
                                                                                                style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                                                <a href="https://ackberrycloud.com"
