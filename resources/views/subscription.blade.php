    ...
    <div class="hk-pg-wrapper">
        ...
        <div class="container">
            ...
            <div class="hk-pg-header">
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Subscription Summary</h4>
            </div>
            <!-- /Title -->
            ...
            <div class="row">
                <div class="col-xl-12">
                    <section class="hk-sec-wrapper">
                        <h5 class="hk-sec-title">All Subscriptions</h5>
                        <p class="mb-40">Subscriptions </p>
                        <div class="row">
                            <div class="col-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($sub->subscription_status == "Deactivated")
                                                    <label class="badge badge-danger">{{ $sub->subscription_status }}</label>
                                                @endif
                                                ...
                                                @if($sub->subscription_status == "Active")
                                                    <label class="badge badge-success">{{ $sub->subscription_status }}</label>
                                                @endif
                                                @if($sub->subscription_status == "Off")
                                                    <label class="badge badge-danger">{{ $sub->subscription_status }}</label>
                                                @endif
                                            </td>
                                        </tr>
